...
// popup_guide_10stop: "After displaying the guide icon, <B>\"10 seconds\" followed by <span style='color:var(--softm-stop)'>Exit</span></B>. "
            ...
            permission_grant_on_app_select : 'Select "<B>God\'s Whisper</B>"',
            ...
            permission_grant_on_for_accessibility3 : 'Select "<B>God\'s Whisper</B>"',
...
$( document ).ready(function() {
  ...
  if ( document.querySelector('.mdc-drawer') ) {
    ...
    drawerListEl.addEventListener('click', (event) => {
        ...
        setTimeout(function () {
            ...
            if ( url  === "goto_map_store.html" ) {
              fn_GotoMarket("net.softm.god.whisper");
              drawer.innerList.selectedIndex = window.drawerSelectedIndex;
    ...
    window.material.confirm = function (v, f, felse) {
      ...
      document.querySelector(".basic.mdc-dialog .mdc-dialog__actions button:nth-child(1)").style.visibility = "visible";    
    ...
    window.material.alert = function (v, f,felse) {
      ...
      document.querySelector(".basic.mdc-dialog .mdc-dialog__actions button:nth-child(1)").style.visibility = "hidden";    
...
var footerNavigationUrl = ["index.html","pray.html","profile.html","membership.html","qna.html","run_option.html","developer_support.html"];
