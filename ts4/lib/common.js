      ...
      en: {
        translation: {
          label: {
            ...
            overlay_hide_wait_time: "Shortcut pop-up wait time",
          ...
          message:{
            ...
            first_start2 : "When plugged in, navigation starts",
            first_start3 : "Home/Work/Favorites",
            first_start4 : "Play music",
            first_start5 : "Connect to Bluetooth/Wi-Fi",
...
// popup_guide_10stop: "After displaying the guide icon, <B>\"10 seconds\" followed by <span style='color:var(--softm-stop)'>Exit</span></B>. "
            ...
            overlay_hide_wait_time: "Time for the shortcut popup to appear and disappear",
      ...
      ko : {
        translation: {
          label: {
            ...
            overlay_hide_wait_time: "바로가기 팝업 대기시간",
          ...
          message:{
            ...
            first_start3 : "집/회사/즐겨찾기",
            first_start4 : "음악실행",
            first_start5 : "블루투스/와이파이 연결",
...
//            popup_guide_10stop: "안내아이콘 표시후, <B>\"10초\" 뒤에 안내를 <span style='color:var(--softm-stop)'>종료</span></B> 합니다."
            ...
            overlay_hide_wait_time: "바로가기 팝업이 표시되고 사라지는 시간",
            ...
            permission_grant_app_select : '"<B>티맵바로가기</B>" 앱을 선택하세요.',

            permission_grant_on_for_overlay1 : '"<B>티맵바로가기</B>" 선택',
            ...
            permission_grant_on_for_notification_access : '"<B>티맵바로가기</B>" 선택',
            permission_grant_on_for_notification_access_2 : '사용 권한 "<b>켬</b>"',

            permission_grant_on_for_location_information_access : '"<B>티맵바로가기</B>"은 앱이 종료되었거나 사용 중이 아닐 때도 위치 데이터를 수집하여 티맵 실행시 중복 실행을 방지하는 기능을 제공합니다.',
            ...
            permission_grant_on_for_accessibility3 : '"<B>티맵바로가기</B>" 선택',
    ...
    drawerListEl.addEventListener('click', (event) => {
        ...
        setTimeout(function () {
            ...
            if ( url  === "goto_map_store.html" ) {
              fn_GotoMarket("net.softm.startnavi.shortcut");
              drawer.innerList.selectedIndex = window.drawerSelectedIndex;
