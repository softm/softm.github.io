var messages  = {
      en: {
        translation: {
          label: {
            app_name: "AutoRun Navi",
            top_bar: "AutoRun Navi",
...
// popup_guide_10stop: "After displaying the guide icon, <B>\"10 seconds\" followed by <span style='color:var(--softm-stop)'>Exit</span></B>. "
            ...
            permission_grant_app_select:'Please select the app "<B>AutoRun Navi</B>".',
            ...
            permission_grant_on_for_location_information_access : '"<B>AutoRun Navi</B>" collects location data even when the app is closed or not in use, and provides a function to prevent duplicate execution when running Navigation.',
            ...
            permission_grant_on_for_accessibility3 : 'Select "<B>AutoRun Navi</B>" from the list of installed apps, then click "<B>Disable</B>".',
