...
// popup_guide_10stop: "After displaying the guide icon, <B>\"10 seconds\" followed by <span style='color:var(--softm-stop)'>Exit</span></B>. "
            ...
            permission_grant_app_select:'Please select the app "<B>Navi Auto Start</B>".',
            ...
            permission_grant_on_for_accessibility_reset : '<b>Accessibility permission has been revoked</b>.<br/><br/>For normal operation, <B>turn off</B> the permission -> <B>turn it on</B>".',
            permission_grant_on_for_accessibility_reset4 : '<b>Turn off"</b> the permissions -&gt; <b>"Turn on"</b>.',
...
//            popup_guide_10stop: "안내아이콘 표시후, <B>\"10초\" 뒤에 안내를 <span style='color:var(--softm-stop)'>종료</span></B> 합니다."
            ...
            permission_grant_on_for_accessibility_reset : '<b>접근성 권한이 해제</b>되었습니다.<br/><br/>정상 동작을 위해 <B>권한</B>을 "<B>껏다</B>" -> "<B>켜세요</B>".',
            permission_grant_on_for_accessibility_reset4 : '사용 권한을 <b>"껏다"</b> -&gt; <b>"켜세요"</b>.',
