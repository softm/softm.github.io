var messages  = {
      en: {
        translation: {
          label: {
            app_name: "Auto Run Navi",
            top_bar: "Auto Run Navi",
...
// popup_guide_10stop: "After displaying the guide icon, <B>\"10 seconds\" followed by <span style='color:var(--softm-stop)'>Exit</span></B>. "
            ...
            permission_grant_app_select:'Please select the app "<B>Auto Run Navi</B>".',
            ...
            permission_grant_on_for_location_information_access : '"<B>Auto Run Navi</B>" collects location data even when the app is closed or not in use, and provides a function to prevent duplicate execution when running Navigation.',
            ...
            permission_grant_on_for_accessibility3 : 'Select "<B>Auto Run Navi</B>" from the list of installed apps, then click "<B>Disable</B>".',
...
//            popup_guide_10stop: "안내아이콘 표시후, <B>\"10초\" 뒤에 안내를 <span style='color:var(--softm-stop)'>종료</span></B> 합니다."
            ...
            permission_grant_on_for_ignore_battery : '정상적인 앱 사용을 위해 해당 어플을 "<B>배터리 사용량 최적화</B>" 목록에서 "<B>제외</B>"해야 합니다.\\n"<B>알림바</B>"를 제거하기 위해 필요합니다.',
