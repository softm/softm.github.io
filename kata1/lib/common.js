...
//            popup_guide_10stop: "안내아이콘 표시후, <B>\"10초\" 뒤에 안내를 <span style='color:var(--softm-stop)'>종료</span></B> 합니다."
            ...
            permission_grant_app_select : '"<B>농수산경매</B>" 앱을 선택하세요.',

            permission_grant_on_for_overlay1 : '"<B>농수산경매</B>" 선택',
            ...
            permission_grant_on_for_notification_access : '"<B>농수산경매</B>" 선택',
            permission_grant_on_for_notification_access_2 : '사용 권한 "<b>켬</b>"',

            permission_grant_on_for_location_information_access : '"<B>농수산경매</B>"은 앱이 종료되었거나 사용 중이 아닐 때도 위치 데이터를 수집하여 티맵 실행시 중복 실행을 방지하는 기능을 제공합니다.',
            ...
            permission_grant_on_for_accessibility3 : '"<B>농수산경매</B>" 선택',
    ...
    drawerListEl.addEventListener('click', (event) => {
        ...
        setTimeout(function () {
            ...
            if ( url  === "goto_map_store.html" ) {
              fn_GotoMarket("net.softm.data.katauction");
              drawer.innerList.selectedIndex = window.drawerSelectedIndex;
