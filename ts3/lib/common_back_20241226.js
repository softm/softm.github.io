...
// popup_guide_10stop: "After displaying the guide icon, <B>\"10 seconds\" followed by <span style='color:var(--softm-stop)'>Exit</span></B>. "
            ...
            permission_grant_on_for_background_location_information_access : '"<B>Drive Auto Nav</B>" uses location data when running destination guidance.',
            ...
            permission_grant_on_for_accessibility3 : 'Select "<B>Drive Auto Nav</B>" from the list of installed apps".',
...
//            popup_guide_10stop: "안내아이콘 표시후, <B>\"10초\" 뒤에 안내를 <span style='color:var(--softm-stop)'>종료</span></B> 합니다."
            ...
            permission_grant_on_for_background_location_information_access : '"<B>티맵바로가기</B>"은 목적지 안내 실행시 정밀도를 높이기 위해 <B>백그라운드</B>에서 위치 데이터를 활용합니다.',
            ...
            permission_grant_on_for_accessibility3 : '설치된 앱 목록에서 "<B>티맵바로가기</B>"을 선택합니다.',
