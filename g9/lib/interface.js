...
/**
 * API 801 : SelectPayClass
 */
function fn_SelectPrayClass(fromDt,toDt,title,groups,callBackFunc) {
	var result = { "header":{ "api":"801" }, "body":{ "fromDt":fromDt,"toDt":toDt,"title":title,"groups":groups, "callBackFunc":callBackFunc } };
	 if(CommonUtil.fn_IS_APP() == "I" || CommonUtil.fn_IS_APP() == "A"){
		 fn_Js_Bridge(result);
	 }else{
		 eval(callBackFunc + "('')");
...
/**
 * API 802 : SelectOnePrayClass
 */
function fn_SelectOnePrayClass(docId,callBackFunc) {
	var result = { "header":{ "api":"802" }, "body":{ "docId":docId, "callBackFunc":callBackFunc } };
	 if(CommonUtil.fn_IS_APP() == "I" || CommonUtil.fn_IS_APP() == "A"){
		 fn_Js_Bridge(result);
	 }else{
		 eval(callBackFunc + "('')");
...
/**
 * API 804 : DeletePrayClass
 */
function fn_DeletePrayClass(docId,callBackFunc) {
	var result = { "header":{ "api":"804" }, "body":{ "docId":docId, "callBackFunc":callBackFunc } };
	 if(CommonUtil.fn_IS_APP() == "I" || CommonUtil.fn_IS_APP() == "A"){
		 fn_Js_Bridge(result);
	 }else{
		 eval(callBackFunc + "('')");
...
/**
 * API 805 : AddPartyPrayClass
 */
function fn_AddPartyPrayClass(docId,callBackFunc) {
	var result = { "header":{ "api":"805" }, "body":{ "docId":docId, "callBackFunc":callBackFunc } };
	 if(CommonUtil.fn_IS_APP() == "I" || CommonUtil.fn_IS_APP() == "A"){
		 fn_Js_Bridge(result);
	 }else{
		 eval(callBackFunc + "('')");
...
/**
 * API 806 : RemovePartyPrayClass
 */
function fn_RemovePartyPrayClass(docId,callBackFunc) {
	var result = { "header":{ "api":"806" }, "body":{ "docId":docId, "callBackFunc":callBackFunc } };
	 if(CommonUtil.fn_IS_APP() == "I" || CommonUtil.fn_IS_APP() == "A"){
		 fn_Js_Bridge(result);
	 }else{
		 eval(callBackFunc + "('')");
...
/**
 * API 807 : DonePartyPrayClass
 */
function fn_DonePartyPrayClass(docId,callBackFunc) {
	var result = { "header":{ "api":"807" }, "body":{ "docId":docId, "callBackFunc":callBackFunc } };
	 if(CommonUtil.fn_IS_APP() == "I" || CommonUtil.fn_IS_APP() == "A"){
		 fn_Js_Bridge(result);
	 }else{
		 eval(callBackFunc + "('')");
...
/**
 * API 808 : DonePartyPrayClass
 */
function fn_NotPartyPrayClass(docId,callBackFunc) {
	var result = { "header":{ "api":"808" }, "body":{ "docId":docId, "callBackFunc":callBackFunc } };
	 if(CommonUtil.fn_IS_APP() == "I" || CommonUtil.fn_IS_APP() == "A"){
		 fn_Js_Bridge(result);
	 }else{
		 eval(callBackFunc + "('')");
...
/**
 * API 820 : SavePrayMemo
 */
function fn_SavePrayMemo(timestampId,memo,callBackFunc) {
	var result = { "header":{ "api":"820" }, "body":{ "timestampId":timestampId, "memo":memo, "callBackFunc":callBackFunc } };
	 if(CommonUtil.fn_IS_APP() == "I" || CommonUtil.fn_IS_APP() == "A"){
		 fn_Js_Bridge(result);
	 }else{
		 eval(callBackFunc + "('')");
...
/**
 * API 821 : SelectPrayMemo
 */
function fn_SelectPrayMemo(timestampIds,callBackFunc) {
	var result = { "header":{ "api":"821" }, "body":{ "timestampIds":timestampIds, "callBackFunc":callBackFunc } };
	 if(CommonUtil.fn_IS_APP() == "I" || CommonUtil.fn_IS_APP() == "A"){
		 fn_Js_Bridge(result);
	 }else{
		 eval(callBackFunc + "('')");
 ...
 * API 900 : BindAlarm
 */
function fn_BindAlarm(callBackFunc) {
	var result = { "header":{ "api":"900" }, "body":{ "callBackFunc":callBackFunc } };
	 if(CommonUtil.fn_IS_APP() == "I" || CommonUtil.fn_IS_APP() == "A"){
		 fn_Js_Bridge(result);
	 }else{
		 eval(callBackFunc + "('')");
 ...
 * API 901 : AddAlarm
 */
function fn_AddAlarm(prayClass, callBackFunc) {
	var result = { "header":{ "api":"901" }, "body":{ "prayClass":prayClass, "callBackFunc":callBackFunc } };
	 if(CommonUtil.fn_IS_APP() == "I" || CommonUtil.fn_IS_APP() == "A"){
		 fn_Js_Bridge(result);
	 }else{
		 eval(callBackFunc + "('')");
